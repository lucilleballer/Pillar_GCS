...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UAVTalk_t, stringdata) + ofs \
...
void UAVTalk::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        UAVTalk *_t = static_cast<UAVTalk *>(_o);
        switch (_id) {
        case 0: { int _r = _t->read();
...
const QMetaObject UAVTalk::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UAVTalk.data,
      qt_meta_data_UAVTalk,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UAVTalk.stringdata))
        return static_cast<void*>(const_cast< UAVTalk*>(this));
